            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>NIM</label>
                        <input type="text" name="nim_mhs" value="<?php echo $row['nim_mhs'] 
...
<div class="form-group">
<label>Jurusan</label>
<textarea class="form-control" name="jurusan_mhs" 
placeholder="Masukkan Jurusan Mahasiswa" rows="4"><?php echo $row['jurusan_mhs'] ?>
</textarea>
</div>
